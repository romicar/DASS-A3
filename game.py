...
file1 = open("error.log","w")
sys.stderr.write = file1.write
...
from characters import spawnBarbarian, move_barbarians, spawnArcher, move_archers, spawnDragon, move_dragons, spawnBalloon, move_balloons, clearTroops, spawnStealths, spawnHealer,move_healers
...
while(True):
    ...
    if ch == 'w':
        ...
        spawnStealths(V.spawn_points[0])
    elif ch == '8':
        spawnStealths(V.spawn_points[1])
    elif ch == '9':
        spawnStealths(V.spawn_points[2])
    elif ch == '4':
